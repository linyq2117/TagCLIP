...
if __name__ == "__main__":
    ...
    parser.add_argument("--split_file", default="/local_root/datasets/VOC2012/ImageSets/Segmentation/train.txt", type=str)
    ...
    if 'bg' in args.cam_type or 'png' in args.cam_type:
        iou = run_eval_cam(args, True, is_coco=is_coco)
    else:
        if args.cam_eval_thres < 1:
